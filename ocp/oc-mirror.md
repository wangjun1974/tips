...
### List Bucket via bash script 
#!/usr/bin/env bash

# Example: ./list-buckets.sh example.url.com:9000 username password bucket-name
...
mirror:
  operators:
    - catalog: registry.redhat.io/redhat/redhat-operator-index:v4.15
      targetCatalog: "my-1-catalog-v4.15"
      packages:
        - name: advanced-cluster-management
          channels:
            - name: 'release-2.10'
    ...
    - catalog: registry.redhat.io/redhat/redhat-operator-index:v4.15
      packages:
        ...
        - name: local-storage-operator
          channels:
            - name: 'stable'
              minVersion: 'v4.15.0-202406101406'
              maxVersion: 'v4.15.0-202406101406'            
        - name: odf-operator
          channels:
            - name: 'stable-4.15'
              minVersion: 'v4.15.3-rhodf'
              maxVersion: 'v4.15.3-rhodf'
        - name: ocs-operator
          channels:
            - name: 'stable-4.15'
              minVersion: 'v4.15.3-rhodf'
        ...
        - name: metallb-operator
          channels:
            - name: stable
              minVersion: 'v4.15.0-202406111806'
              maxVersion: 'v4.15.0-202406111806'
        - name: openshift-gitops-operator
          channels:
            - name: latest
              minVersion: 'v1.12.3'
...
$ cd /oc-mirror
$ /usr/local/bin/oc-mirror --from ./huawei_mirror_seq1_000000.tar docker://registry.example.com:5000 --rebuild-catalogs
...
mirror:
  additionalImages: # List of additional images to be included in imageset
    ...
    - name: k8s.gcr.io/sig-storage/csi-snapshotter:v4.2.1
    - name: k8s.gcr.io/sig-storage/snapshot-controller:v4.2.1
    ...
    - catalog: registry.redhat.io/redhat/redhat-operator-index:v4.14
      packages:
        ...
        - name: kubernetes-nmstate-operator
          channels:
            - name: 'stable'
              minVersion: '4.14.0-202407310940'
              maxVersion: '4.14.0-202407310940'                         
        - name: local-storage-operator
          channels:
            - name: 'stable'
              minVersion: 'v4.14.0-202407260844'
              maxVersion: 'v4.14.0-202407260844'            
        - name: odf-operator
          channels:
            - name: 'stable-4.14'
              minVersion: 'v4.14.9-rhodf'
              maxVersion: 'v4.14.9-rhodf'
        - name: ocs-operator
          channels:
            - name: 'stable-4.14'
              minVersion: 'v4.14.9-rhodf'
        ...
        - name: metallb-operator
          channels:
            - name: stable
              minVersion: 'v4.14.0-202407221140'
              maxVersion: 'v4.14.0-202407221140'
        - name: openshift-gitops-operator
          channels:
            - name: latest
              minVersion: 'v1.13.1'
      ...
      packages:
        ...
        - name: nfd
          channels:
            - name: stable
              minVersion: '4.14.0-202405281408'
              maxVersion: '4.14.0-202407021509'
        - name: cluster-logging
          channels:
            - name: stable-5.9
              minVersion: 'v5.9.3'
        ...
        - name: ansible-automation-platform-operator
          channels:
            - name: 'stable-2.4-cluster-scoped'
              minVersion: 'v2.4.0-0.1718152680'
              maxVersion: 'v2.4.0-0.1720482740'
    - catalog: registry.redhat.io/redhat/redhat-marketplace-index:v4.14
      packages:
        - name: k10-kasten-operator-paygo-rhmp
          channels:
...
mirror:
  operators:
    - catalog: registry.redhat.io/redhat/redhat-operator-index:v4.15
      targetCatalog: "metallb-catalog"
      packages:
        - name: metallb-operator
          channels:
            - name: stable
              minVersion: 'v4.15.0-202408091808'
              maxVersion: 'v4.15.0-202408091808' 
EOF
$ rm -rf output-dir
$ /usr/local/bin/oc-mirror --config ./image-config-realse-local.yaml file://output-dir 2>&1 | tee -a /tmp/oc-mirror-4.15 
$ /usr/local/bin/oc-mirror --from ./mirror_seq1_000000.tar docker://registry.example.com:5000 --rebuild-catalogs
...
### script mirror operator for disconnected env 
```
#!/bin/bash

CATALOG='registry.redhat.io/redhat/redhat-operator-index:v4.18'

for packagename in kubevirt-hyperconverged kubernetes-nmstate-operator local-storage-operator odf-operator ocs-operator mcg-operator cincinnati-operator node-healthcheck-operator self-node-remediation metallb-operator mtv-operator redhat-oadp-operator advanced-cluster-management multicluster-engine odf-csi-addons-operator lvms-operator
do
