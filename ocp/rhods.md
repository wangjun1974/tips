```
### 同步离线镜像
### https://access.redhat.com/documentation/en-us/red_hat_openshift_ai_self-managed/2.5
### 同步 rhods-operator, servicemeshoperator 和 serverless-operator
### additionalImages 来自 https://github.com/red-hat-data-services/rhods-disconnected-install-helper/
### https://github.com/red-hat-data-services/rhods-disconnected-install-helper/blob/main/rhods-2.5.md
cd /tmp
cat <<EOF > image-config-realse-local-jwang.yaml
